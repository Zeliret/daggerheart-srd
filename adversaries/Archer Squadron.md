...
**_Suppressing Fire:_** **Mark a Stress** to target a point within Far range. Until the next roll with Fear, a creature who moves within Close range of that point must make an **Agility Reaction Roll**. On a failure, they take **2d6+3** physical damage. On a success, they take half damage.
