...
- **Motives & Tactics:** Command inferiors, curse the invaders
- **Difficulty:** 16 | **Thresholds:** 12/24 | **HP:** 6 | **Stress:** 5
- **ATK:** +2 | **Swipe:** Melee | 2d8+2 phy
...
**_Missing Organs:_** The Empress’s internal organs have been removed and placed into six crystal containers _hidden_ throughout her tomb. Each time the PCs find and destroy one, the Empress marks a HP.
...
**_Deathless Obedience:_** Up to three times per scene, you can **spend a Fear** to spotlight any number of allies within Close range. If any attacks succeed against the same target, combine the damage.
