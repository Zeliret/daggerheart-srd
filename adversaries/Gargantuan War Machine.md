...
- **ATK:** +7 | **Fists of Iron:** Close | 4d12+10 phy
- **Experience:** Unbreakable +3

### FEATURES

**_Relentless (3):_** The Machine can be spotlighted up to three times per GM turn. **Spend Fear** as usual to spotlight it.

**_Awesome Size:_** When the Machine enters the battlefield, each PC must either lose a Hope or mark **1d4** Stress.

**_Rocket Punch:_** **Mark a Stress** to make an attack against a PC within Close range. On a success, the target takes **4d12+10** direct physical damage and marks 2 Armor Slots without gaining their benefits.

**_Ground-Breaking Stomp:_** **Spend a Fear** to choose a point within Close range and make an attack roll against all enemies within Close range of that point. Targets the attack succeeds against take **4d12** direct physical damage and are _Vulnerable_ until they are spotlighted. Additionally, the entire area becomes rubble, and a PC must succeed on an **Agility Reaction Roll (16)** to move through it.
