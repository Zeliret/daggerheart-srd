...
**_Awesome Size:_** When the Machine enters the battlefi eld, each PC must either lose a Hope or mark 1d4 Stress.

**_Rocket Punch:_** Mark a Stress to make an attack against a PC within Close range. On a success, the target takes 4d12+10 direct physical damage and marks 2 Armor Slots without gaining their benefi ts.
