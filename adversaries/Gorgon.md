...
**_Relentless (2):_** The Gorgon can be spotlighted up to two times per GM turn. **Spend Fear** as usual to spotlight them.

**_Sunsear Arrows:_** When the Gorgon makes a successful standard attack, the target Glows until the end of the scene and can’t become _Hidden_. Attack rolls made against a Glowing target have advantage.
