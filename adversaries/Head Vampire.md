...
**_Terrifying:_** When the Vampire makes a successful attack, all PCs within Far range lose a Hope and you gain a Fear.

**_Look into My Eyes:_** A creature who moves into Melee range of the Vampire must make an **Instinct Reaction Roll**. On a failure, you gain **1d4** Fear.

**_Feed on Followers:_** When the Vampire is within Melee range of an ally, they can cause the ally to mark a HP. The Vampire then clears a HP.
