...
- **Motives & Tactics:** Crack the earth, melt, protect treasure
- **Difficulty:** 19 | **Thresholds:** 30/50 | **HP:** 6 | **Stress:** 4
- **ATK:** +6 | **Tooth & Claw:** Close | 4d10+8 phy
- **Experience:** Mountains +4

### FEATURES

**_Relentless (3):_** The Dragon can be spotlighted up to three times per GM turn. **Spend Fear** as usual to spotlight it.
...
**_Hot-Blooded:_** When a creature makes a successful attack against the Dragon within Very Close range, the Dragon’s blood erupts from the wound and burns the attacker, forcing them to **mark an Armor Slot**. If they can’t **mark an Armor Slot**, they mark **1d4** HP.
