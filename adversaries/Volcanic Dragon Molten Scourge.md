...
**_Relentless (3):_** The Molten Scourge can be spotlighted up to three times per GM turn. **Spend Fear** as usual to spotlight them.

**_Cracked Scales:_** When the Molten Scourge takes damage, roll a number of **d6s** equal to HP marked. For each result of 4 or higher, you gain a Fear.
...
**_Volcanic Breath:_** When the Molten Scourge takes Major damage, roll a **d10**. On a result of 8 or higher, the Molten Scourge breathes a flow of lava in front of them within Far range. All targets in that area must make an **Agility Reaction Roll**. Targets who fail take **2d10+4** physical damage, mark **1d4** Stress, and are _Vulnerable_ until they clear a Stress. Targets who succeed take half damage and must **mark a Stress**.
