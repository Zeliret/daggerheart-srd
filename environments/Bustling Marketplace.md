...
**_Tip the Scales - Passive:_** PCs can gain advantage on a **Presence Roll** by offering a handful of gold as part of the interaction. Will any coin be accepted, or only local currency? _How overt are the PCs in offering this bribe?_

**_Unexpected Find - Action:_** Reveal to the PCs that one of the merchants has something they want or need, such as food from their home, a rare book, magical components, a dubious treasure map, or a magical key. _What cost beyond gold will the merchant ask for in exchange for this rarity?_
