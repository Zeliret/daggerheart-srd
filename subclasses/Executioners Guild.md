...
**_Ambush:_** Your “_Marked for Death_” feature uses **d6s** instead of **d4s**.
...
**_Scorpion’s Poise:_** You gain a +2 bonus to your Evasion against attacks made by a creature you’ve _Marked for Death_.

### MASTERY FEATURES

**_True Strike:_** Once per long rest when you fail an attack, you can **spend a Hope** to make it a success instead.

**_Backstab:_** Your “_Marked for Death_” feature uses **d8s** instead of **d6s**.
